  ...
  describe("considers functions as first class citizens", function(){
    ...
    it("may return arrays that contains functions and so on", function(){
        ...
        function example(){
           ...
           return[ function array (arg) {return[0, 10]  } ]   // write the missing code here
        }
    ...
    it("can create closures with several free variables", function(){
        function external(){
          ...
          //return internal();  // ===>>> al no estar definido el resultado de external, pues entonces es "undefined"
        }
    ...
    it("may return arrays that contains closures and so on", function(){
        function example(){
           return[ function array (arg) {return[0, arg + 9 ]  } ] // write the missing code here
    ...
    it("may have functions as the input and the output", function(){      // =====> ??????? WHAAATTTT????
